...
`,pp=3e3;function mp(e,t,n=pp){let[r,i]=(0,x.useState)(0);return(0,x.useEffect)(()=>{let r=Number.isFinite(e)?Math.max(0,Math.floor(e)):0;if(i(0),!t||r===0)return;let a=n/r,o=0,s,c=()=>{o+=1,i(o),o<r&&(s=window.setTimeout(c,a))};return s=window.setTimeout(c,a),()=>{s&&window.clearTimeout(s)}},[n,t,e]),r}function hp({value:e,label:t,shouldStart:n}){let r=mp(e,n);return(0,A.jsxs)(`article`,{className:`stat-card liquid-glass-effect`,children:[(0,A.jsx)(`strong`,{className:`stat-value`,"aria-label":String(e),children:r}),(0,A.jsx)(`span`,{className:`stat-label`,children:t})]})}function gp(){let e=lp(),t=(0,x.useRef)(null),[n,r]=(0,x.useState)(!1);return(0,x.useEffect)(()=>{let e=t.current;if(!e||n)return;let i=new IntersectionObserver(([e])=>{e.isIntersecting&&(r(!0),i.disconnect())},{threshold:.2});return i.observe(e),()=>i.disconnect()},[n]),(0,A.jsx)(_p,{ref:t,children:(0,A.jsxs)(`div`,{className:`stats-grid`,children:[(0,A.jsx)(hp,{value:e,label:`Carreras`,shouldStart:n}),(0,A.jsx)(hp,{value:280,label:`Egresados/as`,shouldStart:n}),(0,A.jsx)(hp,{value:854,label:`Estudiantes actuales`,shouldStart:n})]})})}var _p=Ha.section`
...
`,vp=[{id:`slide-1`,image:Qa},{id:`slide-2`,image:$a},{id:`slide-3`,image:xo}],yp=()=>{let[e,t]=(0,x.useState)(0),n=()=>{t(e=>(e-1+vp.length)%vp.length)},r=()=>{t(e=>(e+1)%vp.length)},i=vp[e];return(0,A.jsx)(bp,{style:{"--carousel-bg":`url(${i.image})`},children:(0,A.jsxs)(`div`,{className:`carousel-shell`,children:[(0,A.jsx)(`button`,{type:`button`,className:`carousel-nav nav-prev`,onClick:n,"aria-label":`Imagen anterior`,children:(0,A.jsx)(Df,{icon:Vf})}),(0,A.jsx)(`button`,{type:`button`,className:`carousel-nav nav-next`,onClick:r,"aria-label":`Siguiente imagen`,children:(0,A.jsx)(Df,{icon:Mf})}),(0,A.jsx)(`div`,{className:`carousel-dots`,role:`tablist`,"aria-label":`Selector de imagen`,children:vp.map((n,r)=>(0,A.jsx)(`button`,{type:`button`,className:`dot ${r===e?`is-active`:``}`,onClick:()=>t(r),"aria-label":`Ver imagen ${r+1}`,"aria-current":r===e?`true`:`false`},n.id))})]})})},bp=Ha.section`
    width: 100%;
    max-width: 100%;
    box-sizing: border-box;
    height: 400px;
...
`;function xp(){return(0,A.jsxs)(Sp,{children:[(0,A.jsx)(`div`,{className:`directivos-figure`,"aria-hidden":`true`,children:(0,A.jsx)(`img`,{src:to,alt:`Equipo directivo`,className:`directivos-image`})}),(0,A.jsxs)(`div`,{className:`directivos-card liquid-glass-effect`,children:[(0,A.jsx)(`h2`,{children:`"Aprender es un proceso que se hace en comunidad"`}),(0,A.jsx)(`p`,{children:`Equipo Directivo`})]})]})}var Sp=Ha.section`
    --qa-purple-a: 174, 102, 220;
    --qa-purple-b: 148, 78, 198;
    --qa-purple-c: 126, 62, 176;
...
`,Cp=Object.assign({"../assets/img/BOTONERA OFERTA PERMANENTE VERA 2026 ELVERA.EDU.AR OPT-11.png":Ua,"../assets/img/Campus-Virtual.webp":Wa,"../assets/img/adorno.png":Ga,"../assets/img/banner/PORTADA 2.png":Ka,"../assets/img/banner/PORTADA.png":qa,"../assets/img/banner/banner.png":Ja,"../assets/img/calendar.webp":Ya,"../assets/img/campus-virtual.png":Xa,"../assets/img/carousel/1.png":Za,"../assets/img/carousel/2.jpg":Qa,"../assets/img/carousel/3.png":$a,"../assets/img/computer-screen.jpg":eo,"../assets/img/directivos.png":to,"../assets/img/gestion-regencia.avif":no,"../assets/img/icons/Marco superior Vera Card Web.svg":ro,"../assets/img/icons/agronomia.svg":io,"../assets/img/icons/carousel.jpg":ao,"../assets/img/icons/desarrollo-software.svg":oo,"../assets/img/icons/educacion-inicial.svg":so,"../assets/img/icons/educación-primaria.svg":co,"../assets/img/icons/faPenToSquare.svg":lo,"../assets/img/icons/finger-print.svg":uo,"../assets/img/icons/ingles.svg":fo,"../assets/img/icons/lengua.svg":po,"../assets/img/icons/musica.svg":mo,"../assets/img/icons/person-plus.svg":ho,"../assets/img/icons/profesorado-de-arte.svg":go,"../assets/img/icons/recursos-humanos.svg":L,"../assets/img/icons/redes-y-ciberseguridad.svg":R,"../assets/img/icons/trama-icon.svg":_o,"../assets/img/inscripciones.jpg":vo,"../assets/img/inscripciones.png":yo,"../assets/img/logo-png.png":bo,"../assets/img/news-banner.jpg":xo,"../assets/img/novedades.png":So,"../assets/img/old-man-studying.jpeg":Co,"../assets/img/testimonials/Dulce.png":wo,"../assets/img/testimonials/Fernando.png":To,"../assets/img/testimonials/Jaquelina.png":Eo,"../assets/img/testimonials/Lihuen.png":Do,"../assets/img/trama.jpg":Oo,"../assets/img/tramite-online.jpg":ko,"../assets/img/ultimas-noticias.webp":Ao});function wp(e){return e?e.startsWith(`http://`)||e.startsWith(`https://`)||e.startsWith(`/`)?e:Cp[`../assets/img/${e.replace(/^\.?\/?/,``)}`]??null:null}function Tp(e=``){let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?`??`:t.length===1?t[0].slice(0,2).toUpperCase():`${t[0][0]}${t[t.length-1][0]}`.toUpperCase()}function Ep({name:e,imagePath:t,initials:n}){let r=(0,x.useMemo)(()=>wp(t),[t]),[i,a]=(0,x.useState)(!1),o=n||Tp(e);return!r||i?(0,A.jsx)(`span`,{className:`avatar`,"aria-hidden":`true`,children:o}):(0,A.jsx)(`span`,{className:`avatar avatar-image-wrap`,"aria-hidden":`true`,children:(0,A.jsx)(`img`,{src:r,alt:``,className:`avatar-image`,onError:()=>a(!0)})})}var Dp=[{quote:`“Los docentes del Vera están pendientes del estudiante, sus necesidades y su formación. Son profesionales de gran nivel que saben acompañar en el trayecto”.`,name:`Jaquelina Videla`,location:`San Carlos, Mendoza`,imagePath:Eo},{quote:`“En el Vera hay calidad humana, con docentes que están atentos a cada estudiante. La institución mantiene buenas actitudes que generan un sentido de pertenencia y contención”.`,name:`Dulce Bocia`,location:`San Carlos, Mendoza`,imagePath:wo},{quote:`“La cercanía y la calidez son un punto a favor que no hay en otros lugares. Hay acompañamiento, contención e interés para que podamos progresar. Si surge un inconveniente, se busca la manera de solucionarlo”.`,name:`Lihuen Cabello`,location:`La Consulta, Mendoza`,imagePath:Do},{quote:`“Hay flexibilidad para las personas que trabajamos; cuando no podemos cursar, los docentes nos acompañan facilitando el proceso para poder seguir. El acompañamiento y las salidas educativas son para destacar”.`,name:`Fernando Olmedo`,location:`Tunuyan, Mendoza`,imagePath:To}];function Op(){let[e,t]=(0,x.useState)(0),[n,r]=(0,x.useState)(!1);(0,x.useEffect)(()=>{let e=window.matchMedia(`(max-width: 980px)`),t=()=>r(e.matches);return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,x.useEffect)(()=>{if(!n)return;let e=window.setInterval(()=>{t(e=>(e+1)%Dp.length)},5e3);return()=>window.clearInterval(e)},[n]);let i=Dp[e];return(0,A.jsxs)(kp,{children:[(0,A.jsx)(`h2`,{children:`¿Que dicen nuestros estudiantes?`}),(0,A.jsx)(`div`,{className:`recommendations-grid${n?` is-mobile-carousel`:``}`,children:n?(0,A.jsxs)(`article`,{className:`recommendation-card liquid-glass-effect active`,children:[(0,A.jsx)(`p`,{className:`quote`,children:i.quote}),(0,A.jsxs)(`div`,{className:`author-row`,children:[(0,A.jsx)(Ep,{name:i.name,imagePath:i.imagePath,initials:i.initials}),(0,A.jsxs)(`div`,{className:`author-info`,children:[(0,A.jsx)(`strong`,{children:i.name}),(0,A.jsx)(`span`,{children:i.location})]})]})]},i.name):Dp.map(e=>(0,A.jsxs)(`article`,{className:`recommendation-card liquid-glass-effect`,children:[(0,A.jsx)(`p`,{className:`quote`,children:e.quote}),(0,A.jsxs)(`div`,{className:`author-row`,children:[(0,A.jsx)(Ep,{name:e.name,imagePath:e.imagePath,initials:e.initials}),(0,A.jsxs)(`div`,{className:`author-info`,children:[(0,A.jsx)(`strong`,{children:e.name}),(0,A.jsx)(`span`,{children:e.location})]})]})]},e.name))}),n&&(0,A.jsx)(`div`,{className:`carousel-dots`,"aria-label":`Selector de testimonios`,children:Dp.map((n,r)=>(0,A.jsx)(`button`,{type:`button`,className:`carousel-dot${r===e?` active`:``}`,onClick:()=>t(r),"aria-label":`Ver testimonio ${r+1}`},n.name))})]})}var kp=Ha.section`
    --qa-purple-a: 174, 102, 220;
    --qa-purple-b: 148, 78, 198;
    --qa-purple-c: 126, 62, 176;
...
`;function Ap(){return(0,A.jsx)(jp,{className:`liquid-glass-effect`,children:(0,A.jsx)(`p`,{children:`Todos los derechos © 2026 | Instituto de Educación Superior 9-010 Rosario Vera Peñaloza`})})}var jp=Ha.footer`
	--qa-purple-a: 174, 102, 220;
	--qa-purple-b: 148, 78, 198;
	--qa-purple-c: 126, 62, 176;
...
`,Mp=`/vera-page/assets/video_muestra-BSMvJMy5.webm`;function Np(){let{theme:e}=Wn();return(0,A.jsxs)(Pp,{className:`app ${e}`,children:[(0,A.jsx)(Qf,{}),(0,A.jsx)(Fo,{titulo:`Instituto de Educación Superior Rosario Vera Peñaloza`,subtitulo:`Comprometidos con la educación y el desarrollo profesional en nuestra comunidad`,textoBoton:`Conocer las ofertas académicas`,imagenFondoPath:Mp}),(0,A.jsx)(rp,{}),(0,A.jsx)(dp,{}),(0,A.jsx)(yp,{}),` `,(0,A.jsx)(gp,{}),(0,A.jsx)(Op,{}),(0,A.jsx)(xp,{}),(0,A.jsx)(No,{icono:$.tramaIcon,titulo:`TRAMA`,subtitulo:`Espacio Interdisciplinario de Acompañamiento a las Trayectorias Estudiantiles`,imagenFondoPath:`trama.jpg`,textoBoton:`Quiero mas información`}),(0,A.jsx)(Ap,{})]})}var Pp=Ha.div`
  width: min(80%, 1440px);
  margin: 0 auto;
  box-sizing: border-box;
...
`;function Qp(){let{theme:e}=Wn(),{careerCode:t}=vt(),n=String(t??``).trim().toUpperCase(),r=Fp?.careers??{},i=n?r?.[n]:null,a=Array.isArray(i?.sections)?i.sections:[],o=!!(n&&i&&a.length>0);return(0,A.jsxs)($p,{className:`app ${e}`,children:[(0,A.jsx)(Qf,{}),(0,A.jsx)(`main`,{className:`oferta-main`,children:o?a.map((e,t)=>{let r=Xp(e?.type);return(0,A.jsx)(r,{section:e,career:i,careerCode:n},`${e?.type??`section`}-${t}`)}):(0,A.jsxs)(`section`,{className:`not-found`,role:`status`,"aria-live":`polite`,children:[(0,A.jsx)(`p`,{className:`not-found-kicker`,children:`404 Not Found`}),(0,A.jsx)(`h1`,{children:`Carrera no disponible`}),(0,A.jsxs)(`p`,{children:[`No encontramos contenido para el codigo "`,t||`sin-codigo`,`".`]})]})}),(0,A.jsx)(Ap,{})]})}var $p=Ha.div`
  width: min(80%, 1440px);
  margin: 0 auto;
  box-sizing: border-box;
...
`;function sm(){let{pathname:e}=pt();return(0,x.useEffect)(()=>{window.scrollTo({top:0,left:0,behavior:`auto`})},[e]),null}function cm(){return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`svg`,{className:`liquid-glass-filter-definition`,"aria-hidden":`true`,focusable:`false`,children:(0,A.jsxs)(`filter`,{id:`liquid-glass-frosted`,x:`-10%`,y:`-10%`,width:`120%`,height:`120%`,children:[(0,A.jsx)(`feTurbulence`,{type:`fractalNoise`,baseFrequency:`0.025`,numOctaves:`2`,seed:`8`,result:`glassNoise`}),(0,A.jsx)(`feGaussianBlur`,{in:`SourceGraphic`,stdDeviation:`0.02`,result:`glassBlur`}),(0,A.jsx)(`feDisplacementMap`,{in:`glassBlur`,in2:`glassNoise`,scale:`18`,xChannelSelector:`R`,yChannelSelector:`G`})]})}),(0,A.jsx)(sm,{}),(0,A.jsxs)(Ut,{children:[(0,A.jsx)(Vt,{path:`/`,element:(0,A.jsx)(Np,{})}),(0,A.jsx)(Vt,{path:`/tramites-online`,element:(0,A.jsx)(nm,{})}),(0,A.jsx)(Vt,{path:`/oferta-educativa`,element:(0,A.jsx)(Qp,{})}),(0,A.jsx)(Vt,{path:`/oferta-educativa/:careerCode`,element:(0,A.jsx)(Qp,{})}),(0,A.jsx)(Vt,{path:`*`,element:(0,A.jsx)(Bt,{to:`/`,replace:!0})})]})]})}(0,Bn.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(x.StrictMode,{children:(0,A.jsx)(Un,{children:(0,A.jsx)(On,{children:(0,A.jsx)(cm,{})})})}));