...
`;function Nf({icon:e=null,title:t=`Últimas noticias`,description:n=`Mantente informado con las últimas novedades y eventos del instituto.`,imageSrc:r=null,imageAlt:i=``,buttonLabel:a=`➝ Leer más`,buttonType:o=`button`,onClick:s,className:c}){return(0,A.jsx)(Pf,{className:c,children:(0,A.jsxs)(`section`,{className:`home-card`,children:[(0,A.jsx)(`img`,{src:Ga,alt:``,className:`home-card-adorno`,"aria-hidden":`true`}),!!e&&(0,A.jsx)(`div`,{className:`icon-card`,"aria-hidden":`true`,children:(0,A.jsx)(ff,{icon:e})}),(0,A.jsxs)(`div`,{className:`home-card-content`,children:[!!t&&(0,A.jsx)(`h3`,{className:`home-card-title`,children:t}),!!n&&(0,A.jsx)(`p`,{className:`home-card-description`,children:n}),!!r&&(0,A.jsx)(`figure`,{className:`home-card-media`,children:(0,A.jsx)(`img`,{src:r,alt:i||t||`Imagen de la tarjeta`})}),!!a&&(0,A.jsx)(`div`,{className:`home-card-actions`,children:(0,A.jsx)(`button`,{className:`home-card-button`,type:o,onClick:s,children:a})})]})]})})}var Pf=Ha.section`
    width: 100%;
    display: block;
...
`,Ff={faDisplay:mf,fingerPrintIcon:io,tramaIcon:fo,faArrowUpRightFromSquare:wf,faBookOpen:Ef,faCalendarDays:pf,faLaptop:yf,faNewspaper:vf,profesoradoArtesVisuales:co,educacionPrimaria:no,educacionInicial:to,lengua:oo,musica:so,ingles:ao,desarrolloSoftware:eo,redesCiberseguridad:uo,agronomia:Qa,recursosHumanos:lo,faPenToSquare:hf,faLaptopFile:Cf},If=[{icon:Ff.faNewspaper,title:`Últimas noticias`,description:`Mantente informado con las últimas novedades y eventos del instituto.`,imageSrc:Of.ultimasNoticias,buttonLabel:`➝ Leer más`},{icon:Ff.faPenToSquare,title:`Inscripciones abiertas`,description:`¡No pierdas la oportunidad de formar parte de nuestra comunidad educativa!`,imageSrc:Of.inscripcion,buttonLabel:`➝ Inscribirse`},{icon:Ff.faDisplay,title:`Campus virtual`,description:`Campus virtual, recursos en línea para estudiantes y docentes. Accede a materiales de estudio, clases grabadas y más.`,imageSrc:Of.campusVirtual,buttonLabel:`➝ Ingresar`},{icon:Ff.faLaptopFile,title:`Trámite online`,description:`Realiza tus trámites en línea de manera rápida y segura.`,imageSrc:Of.tramite,buttonLabel:`➝ Acceder`}];function Lf({cards:e=If}){return(0,A.jsx)(Rf,{children:e.map((e,t)=>(0,A.jsx)(Nf,{...e},`${e.title}-${t}`))})}var Rf=Ha.section`
    width: 100%;
    display: grid;
...
`;function zf({name:e,icon:t,to:n=`/oferta-educativa`,reflectionColor:r=`rgba(186, 142, 166, 0.72)`}){return(0,A.jsx)(Bf,{className:`careers-buttons`,$reflectionColor:r,children:(0,A.jsxs)(kn,{to:n,className:`careers-button`,children:[(0,A.jsx)(`span`,{className:`careers-icon-shell`,"aria-hidden":`true`,children:(0,A.jsx)(`img`,{src:t,alt:e,className:`careers-icon`})}),(0,A.jsx)(`span`,{className:`careers-label-shell`,children:(0,A.jsx)(`span`,{children:e})})]})})}var Bf=Ha.div`
...
`,Vf={profesorado:{title:`Profesorados`,items:[{code:`PAV`,name:`Profesorado de Artes Visuales`,icon:Ff.profesoradoArtesVisuales,reflectionColor:`rgba(200, 154, 184, 0.78)`},{code:`PEP`,name:`Profesorado de Educacion Primaria`,icon:Ff.educacionPrimaria,reflectionColor:`rgba(177, 165, 202, 0.78)`},{code:`PEI`,name:`Profesorado de Educacion Inicial`,icon:Ff.educacionInicial,reflectionColor:`rgba(196, 150, 170, 0.78)`},{code:`PESLL`,name:`Profesorado de Educacion Secundaria en Lengua y Literatura`,icon:Ff.lengua,reflectionColor:`rgba(168, 157, 188, 0.78)`},{code:`PM`,name:`Profesorado de Musica`,icon:Ff.musica,reflectionColor:`rgba(160, 144, 204, 0.78)`},{code:`PI`,name:`Profesorado de Ingles`,icon:Ff.ingles,reflectionColor:`rgba(154, 169, 215, 0.78)`}]},tecnicatura:{title:`Tecnicaturas`,items:[{code:`TSDS`,name:`Tecnicatura Superior en Desarrollo de Software`,icon:Ff.desarrolloSoftware,reflectionColor:`rgba(142, 147, 186, 0.78)`},{code:`TSRYC`,name:`Tecnicatura Superior en Redes y Ciberseguridad`,icon:Ff.redesCiberseguridad,reflectionColor:`rgba(134, 160, 176, 0.78)`},{code:`TSA`,name:`Tecnicatura Superior en Agronomia`,icon:Ff.agronomia,reflectionColor:`rgba(156, 176, 164, 0.78)`},{code:`TSRH`,name:`Tecnicatura Superior en Recursos Humanos`,icon:Ff.recursosHumanos,reflectionColor:`rgba(190, 160, 151, 0.78)`}]}};function Hf(e=`profesorado`){return Vf[e]??null}function Uf(){return Object.values(Vf).reduce((e,t)=>e+t.items.length,0)}function Wf(e,t=!1,n=!0){let r=Hf(e);return r?(0,A.jsxs)(`article`,{className:`careers-group${t?n?` active`:` hidden`:``}`,children:[(0,A.jsx)(`header`,{className:`careers-group-header`,children:(0,A.jsx)(`h2`,{children:r.title})}),(0,A.jsx)(`div`,{className:`careers-group-grid`,children:r.items.map(e=>(0,A.jsx)(zf,{name:e.name,icon:e.icon,to:`/oferta-educativa/${e.code}`,reflectionColor:e.reflectionColor},e.name))})]},e):null}function Gf({category:e}){let t=e?[e]:[`profesorado`,`tecnicatura`],[n,r]=(0,x.useState)(t[0]??`profesorado`),i=!e&&t.length>1,a=e||n;return(0,A.jsxs)(Kf,{children:[i&&(0,A.jsxs)(`div`,{className:`mobile-selector-shell`,children:[(0,A.jsxs)(`div`,{className:`careers-mobile-selector`,role:`tablist`,"aria-label":`Seleccionar oferta académica`,children:[(0,A.jsx)(`button`,{type:`button`,className:`selector-pill${a===`profesorado`?` active`:``}`,onClick:()=>r(`profesorado`),"aria-pressed":a===`profesorado`,children:`Profesorados`}),(0,A.jsx)(`button`,{type:`button`,className:`selector-pill${a===`tecnicatura`?` active`:``}`,onClick:()=>r(`tecnicatura`),"aria-pressed":a===`tecnicatura`,children:`Tecnicaturas`})]}),(0,A.jsx)(`div`,{className:`mobile-careers-panel`,children:t.map(e=>Wf(e,!0,e===a))})]}),!i&&t.map(e=>Wf(e))]})}var Kf=Ha.section`
  width: 100%;
  display: grid;
  gap: 2rem;
  padding: 2rem 0;
...
`,qf=3e3;function Jf(e,t=qf){let[n,r]=(0,x.useState)(0);return(0,x.useEffect)(()=>{let n=Number.isFinite(e)?Math.max(0,Math.floor(e)):0;if(r(0),n===0)return;let i=t/n,a=0,o,s=()=>{a+=1,r(a),a<n&&(o=window.setTimeout(s,i))};return o=window.setTimeout(s,i),()=>{o&&window.clearTimeout(o)}},[t,e]),n}function Yf({value:e,label:t}){let n=Jf(e);return(0,A.jsxs)(`article`,{className:`stat-card`,children:[(0,A.jsx)(`strong`,{className:`stat-value`,"aria-label":String(e),children:n}),(0,A.jsx)(`span`,{className:`stat-label`,children:t})]})}function Xf(){let e=Uf();return(0,A.jsx)(Zf,{children:(0,A.jsxs)(`div`,{className:`stats-grid`,children:[(0,A.jsx)(Yf,{value:e,label:`Carreras`}),(0,A.jsx)(Yf,{value:280,label:`Egresados/as`}),(0,A.jsx)(Yf,{value:854,label:`Estudiantes actuales`})]})})}var Zf=Ha.section`
...
`,Qf=[{id:`slide-1`,image:Ja},{id:`slide-2`,image:Ya},{id:`slide-3`,image:ho}],$f=()=>{let[e,t]=(0,x.useState)(0),n=()=>{t(e=>(e-1+Qf.length)%Qf.length)},r=()=>{t(e=>(e+1)%Qf.length)},i=Qf[e];return(0,A.jsx)(ep,{style:{"--carousel-bg":`url(${i.image})`},children:(0,A.jsxs)(`div`,{className:`carousel-shell`,children:[(0,A.jsx)(`button`,{type:`button`,className:`carousel-nav nav-prev`,onClick:n,"aria-label":`Imagen anterior`,children:(0,A.jsx)(ff,{icon:Sf})}),(0,A.jsx)(`button`,{type:`button`,className:`carousel-nav nav-next`,onClick:r,"aria-label":`Siguiente imagen`,children:(0,A.jsx)(ff,{icon:_f})}),(0,A.jsx)(`div`,{className:`carousel-dots`,role:`tablist`,"aria-label":`Selector de imagen`,children:Qf.map((n,r)=>(0,A.jsx)(`button`,{type:`button`,className:`dot ${r===e?`is-active`:``}`,onClick:()=>t(r),"aria-label":`Ver imagen ${r+1}`,"aria-current":r===e?`true`:`false`},n.id))})]})})},ep=Ha.section`
    width: 100%;
    max-width: 100%;
    box-sizing: border-box;
    height: 400px;
...
`;function tp(){return(0,A.jsx)(np,{children:(0,A.jsxs)(`div`,{className:`faq-pill`,role:`button`,tabIndex:0,"aria-label":`Preguntas frecuentes`,children:[(0,A.jsx)(`h2`,{children:(0,A.jsx)(`span`,{children:`Preguntas frecuentes`})}),(0,A.jsx)(`div`,{className:`icon-faq`,"aria-hidden":`true`,children:(0,A.jsx)(`span`,{className:`faq-mark`,children:`?`})})]})})}var np=Ha.section`
    width: 100%;
    max-width: 100%;
    box-sizing: border-box;
    padding: 1rem;
...
`;function rp(){return(0,A.jsxs)(ip,{children:[(0,A.jsx)(`div`,{className:`directivos-figure`,"aria-hidden":`true`,children:(0,A.jsx)(`img`,{src:Xa,alt:`Equipo directivo`,className:`directivos-image`})}),(0,A.jsxs)(`div`,{className:`directivos-card`,children:[(0,A.jsx)(`h2`,{children:`"Aprender es un proceso que se hace en comunidad"`}),(0,A.jsx)(`p`,{children:`Equipo Directivo`})]})]})}var ip=Ha.section`
    --qa-purple-a: 174, 102, 220;
    --qa-purple-b: 148, 78, 198;
    --qa-purple-c: 126, 62, 176;
...
`,ap=Object.assign({"../assets/img/BOTONERA OFERTA PERMANENTE VERA 2026 ELVERA.EDU.AR OPT-11.png":Ua,"../assets/img/Campus-Virtual.webp":Wa,"../assets/img/adorno.png":Ga,"../assets/img/banner/banner.png":Ka,"../assets/img/carousel/1.png":qa,"../assets/img/carousel/2.jpg":Ja,"../assets/img/carousel/3.png":Ya,"../assets/img/directivos.png":Xa,"../assets/img/icons/Marco superior Vera Card Web.svg":Za,"../assets/img/icons/agronomia.svg":Qa,"../assets/img/icons/carousel.jpg":$a,"../assets/img/icons/desarrollo-software.svg":eo,"../assets/img/icons/educacion-inicial.svg":to,"../assets/img/icons/educación-primaria.svg":no,"../assets/img/icons/faPenToSquare.svg":ro,"../assets/img/icons/finger-print.svg":io,"../assets/img/icons/ingles.svg":ao,"../assets/img/icons/lengua.svg":oo,"../assets/img/icons/musica.svg":so,"../assets/img/icons/profesorado-de-arte.svg":co,"../assets/img/icons/recursos-humanos.svg":lo,"../assets/img/icons/redes-y-ciberseguridad.svg":uo,"../assets/img/icons/trama-icon.svg":fo,"../assets/img/inscripciones.jpg":po,"../assets/img/logo-png.png":mo,"../assets/img/news-banner.jpg":ho,"../assets/img/trama.jpg":go,"../assets/img/tramite-online.jpg":L,"../assets/img/ultimas-noticias.webp":R});function op(e){return e?e.startsWith(`http://`)||e.startsWith(`https://`)||e.startsWith(`/`)?e:ap[`../assets/img/${e.replace(/^\.?\/?/,``)}`]??null:null}function sp(e=``){let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?`??`:t.length===1?t[0].slice(0,2).toUpperCase():`${t[0][0]}${t[t.length-1][0]}`.toUpperCase()}function cp({name:e,imagePath:t,initials:n}){let r=(0,x.useMemo)(()=>op(t),[t]),[i,a]=(0,x.useState)(!1),o=n||sp(e);return!r||i?(0,A.jsx)(`span`,{className:`avatar`,"aria-hidden":`true`,children:o}):(0,A.jsx)(`span`,{className:`avatar avatar-image-wrap`,"aria-hidden":`true`,children:(0,A.jsx)(`img`,{src:r,alt:``,className:`avatar-image`,onError:()=>a(!0)})})}var lp=[{quote:`"Siempre quise terminar mis estudios, pero la vida me llevo por otro camino. En el Vera, siendo mayor, pude hacerlo realidad y demostrarme que nunca es tarde para aprender."`,name:`Silvia Sosa`,location:`San Carlos, Mendoza`,imagePath:``},{quote:`"El ambiente es motivador y participativo. Los docentes te inspiran a seguir aprendiendo y a creer en vos mismo."`,name:`Luis Serrudo`,location:`San Carlos, Mendoza`,imagePath:``},{quote:`"Gracias al Jardin del Vera Penaloza, pude estudiar tranquila mientras mi hijo crecia en un espacio seguro y educativo."`,name:`Laura Micames`,location:`La Consulta, Mendoza`,imagePath:``},{quote:`"Trabajaba durante el dia y estudiaba de noche, en el Vera encontre apoyo y profesores que realmente entendian mi situacion."`,name:`Pablo Morales`,location:`Tunuyan, Mendoza`,imagePath:``}];function up(){let[e,t]=(0,x.useState)(0),[n,r]=(0,x.useState)(!1);(0,x.useEffect)(()=>{let e=window.matchMedia(`(max-width: 980px)`),t=()=>r(e.matches);return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,x.useEffect)(()=>{if(!n)return;let e=window.setInterval(()=>{t(e=>(e+1)%lp.length)},5e3);return()=>window.clearInterval(e)},[n]);let i=lp[e];return(0,A.jsxs)(dp,{children:[(0,A.jsx)(`h2`,{children:`¿Que dicen nuestros estudiantes?`}),(0,A.jsx)(`div`,{className:`recommendations-grid${n?` is-mobile-carousel`:``}`,children:n?(0,A.jsxs)(`article`,{className:`recommendation-card active`,children:[(0,A.jsx)(`p`,{className:`quote`,children:i.quote}),(0,A.jsxs)(`div`,{className:`author-row`,children:[(0,A.jsx)(cp,{name:i.name,imagePath:i.imagePath,initials:i.initials}),(0,A.jsxs)(`div`,{className:`author-info`,children:[(0,A.jsx)(`strong`,{children:i.name}),(0,A.jsx)(`span`,{children:i.location})]})]})]},i.name):lp.map(e=>(0,A.jsxs)(`article`,{className:`recommendation-card`,children:[(0,A.jsx)(`p`,{className:`quote`,children:e.quote}),(0,A.jsxs)(`div`,{className:`author-row`,children:[(0,A.jsx)(cp,{name:e.name,imagePath:e.imagePath,initials:e.initials}),(0,A.jsxs)(`div`,{className:`author-info`,children:[(0,A.jsx)(`strong`,{children:e.name}),(0,A.jsx)(`span`,{children:e.location})]})]})]},e.name))}),n&&(0,A.jsx)(`div`,{className:`carousel-dots`,"aria-label":`Selector de testimonios`,children:lp.map((n,r)=>(0,A.jsx)(`button`,{type:`button`,className:`carousel-dot${r===e?` active`:``}`,onClick:()=>t(r),"aria-label":`Ver testimonio ${r+1}`},n.name))})]})}var dp=Ha.section`
    --qa-purple-a: 174, 102, 220;
    --qa-purple-b: 148, 78, 198;
    --qa-purple-c: 126, 62, 176;
...
`;function fp(){return(0,A.jsx)(pp,{children:(0,A.jsx)(`p`,{children:`Todos los derechos © 2026 | Instituto de Educación Superior 9-010 Rosario Vera Peñaloza`})})}var pp=Ha.footer`
	--qa-purple-a: 174, 102, 220;
	--qa-purple-b: 148, 78, 198;
	--qa-purple-c: 126, 62, 176;
...
`;function mp(){let{theme:e}=Wn();return(0,A.jsxs)(hp,{className:`app ${e}`,children:[(0,A.jsx)(jf,{}),(0,A.jsx)(xo,{titulo:`Instituto de Educación Superior Rosario Vera Peñaloza`,subtitulo:`Comprometidos con la educación y el desarrollo profesional en nuestra comunidad`,textoBoton:`Conocer las ofertas académicas`,imagenFondoPath:Ka}),(0,A.jsx)(Lf,{}),(0,A.jsx)(Gf,{}),(0,A.jsx)(yo,{icono:Ff.fingerPrintIcon,titulo:`Tecnicatura Superior en Redes y Ciberseguridad`,imagenFondoPath:`news-banner.jpg`,textoBoton:`Nueva carrera ¡Conocela!`}),(0,A.jsx)(tp,{}),(0,A.jsx)(Xf,{}),(0,A.jsx)($f,{}),(0,A.jsx)(rp,{}),(0,A.jsx)(up,{}),(0,A.jsx)(yo,{icono:Ff.tramaIcon,titulo:`TRAMA`,subtitulo:`Espacio Interdisciplinario de Acompañamiento a las Trayectorias Estudiantiles`,imagenFondoPath:`trama.jpg`,textoBoton:`Quiero mas informacion`}),(0,A.jsx)(fp,{})]})}var hp=Ha.div`
  width: min(80%, 1440px);
  margin: 0 auto;
...
`,gp={careers:{TSRYC:{title:`Tecnicatura en Software`,description:`La Tecnicatura en Software es una carrera de nivel superior que te brinda los conocimientos y habilidades necesarios para desarrollar aplicaciones, sistemas y soluciones digitales. A lo largo de la carrera, aprenderás a programar, diseñar interfaces de usuario, gestionar bases de datos y trabajar en equipo para crear productos tecnológicos innovadores.`,image:`https://example.com/images/software.jpg`,sections:[{type:`banner`,content:[{title:`Tecnicatura superior en Desarrollode software`,subtitle:`Formate para crear aplicaciones, sistemas y soluciones digitales`,buttonText:`Inscribite ahora`,image:`https://example.com/images/software-banner.jpg`}]},{type:`info-cards`,quantity:4,content:[{icon:`clock`,title:`Duración`,description:`3 años`},{icon:`checkmark`,title:`Modalidad`,description:`Presencial / a distancia`},{icon:`sand-clock`,title:`Turno`,description:`Vespertino`},{icon:`card`,title:`Título`,description:`Técnico Superior en desarrollo de software`}]},{type:`about`,content:{title:`Acerca de la carrera`,description:`La Tecnicatura en Software es una carrera de nivel superior que te brinda los conocimientos y habilidades necesarios para desarrollar aplicaciones, sistemas y soluciones digitales. A lo largo de la carrera, aprenderás a programar, diseñar interfaces de usuario, gestionar bases de datos y trabajar en equipo para crear productos tecnológicos innovadores.`,image:`https://example.com/images/software-about.jpg`}},{type:`contents`,content:{title:`Contenidos de la carrera`,description:[[`Fundamentos de Redes`,`Sistemas Operativos`,`Introducción a Ciberseguridad`,`Protocolos de Comunicación`,`Administración de Sistemas`],[`Seguridad en Redes`,`Criptografía`,`Análisis de Vulnerabilidades`,`Firewall y Control de Acceso`,`Administración de Bases de Datos`],[`Auditoría de Seguridad`,`Respuesta a Incidentes`,`Cumplimiento Normativo`,`Seguridad en la Nube`,`Proyecto Final`]]}},{type:`profile`,content:{title:`Perfil del egresado`,description:`El egresado de la Tecnicatura en Software estará capacitado para diseñar, desarrollar y mantener aplicaciones y sistemas informáticos. Tendrá habilidades en programación, análisis de requerimientos, diseño de interfaces, gestión de bases de datos y trabajo en equipo. Además, estará preparado para adaptarse a las nuevas tecnologías y tendencias del desarrollo de software.`}},{type:`about`,content:{title:`Salida laboral`,description:`El egresado de la Tecnicatura en Software tiene diversas oportunidades laborales en el campo de la tecnología y el desarrollo de software. Puede desempeñarse como desarrollador de aplicaciones, programador web, analista de sistemas, diseñador de interfaces, administrador de bases de datos, entre otros roles relacionados con la creación y mantenimiento de soluciones digitales. Además, puede trabajar en empresas de tecnología, startups, consultoras o incluso emprender su propio proyecto.`,image:`https://images.ctfassets.net/pdf29us7flmy/1xIWV7IeCPx8D2lEjUq11e/bcb6d6b45eb3d68491f9445d9a63c1fa/GettyImages-473983321.jpg?w=720&q=100&fm=jpg`}},{type:`faq`,questions:[`¿Es presencial o a distancia?`,`¿Cuánto dura la carrera?`,`¿Qué salidas laborales tiene?`],answers:[`La carrera se ofrece en modalidad presencial y a distancia, brindando flexibilidad para adaptarse a las necesidades de los estudiantes.`,`La duración de la carrera es de 3 años, durante los cuales se adquieren los conocimientos y habilidades necesarios para desarrollarse en el campo del software.`,`El egresado de la Tecnicatura en Software tiene diversas oportunidades laborales, incluyendo roles como desarrollador de aplicaciones, programador web, analista de sistemas, diseñador de interfaces y administrador de bases de datos. Puede trabajar en empresas de tecnología, startups, consultoras o emprender su propio proyecto.`]}]}}},_p={clock:gf,checkmark:bf,"sand-clock":pf,card:xf};function vp({image:e,title:t}){let[n,r]=(0,x.useState)(!1),i=!!(e&&!n);return(0,A.jsx)(`div`,{className:`about-media-wrap`,"aria-hidden":i?void 0:`true`,children:i?(0,A.jsx)(`img`,{src:e,alt:t||`Ilustracion de la carrera`,loading:`lazy`,className:`about-media`,onError:()=>r(!0)}):null})}function yp({section:e}){let t=e?.content?.[0]??{};return(0,A.jsx)(Op,{children:(0,A.jsx)(`div`,{className:`career-banner-host`,children:(0,A.jsx)(xo,{titulo:t.title??`Carrera`,subtitulo:t.subtitle??``,textoBoton:t.buttonText??`Inscribite ahora`,imagenFondoPath:t.image??``})})})}function bp({section:e}){let t=Array.isArray(e?.content)?e.content:[];return(0,A.jsx)(Op,{children:(0,A.jsxs)(`section`,{className:`career-block`,children:[(0,A.jsx)(`h3`,{children:`Informacion general`}),(0,A.jsx)(`div`,{className:`cards-grid`,children:t.map((e,t)=>(0,A.jsxs)(`article`,{className:`info-card`,children:[(0,A.jsx)(`img`,{src:Ga,alt:``,className:`info-card-adorno`,"aria-hidden":`true`}),(0,A.jsx)(`div`,{className:`icon-card`,"aria-hidden":`true`,children:(0,A.jsx)(ff,{icon:_p[e?.icon]??Df})}),(0,A.jsxs)(`div`,{className:`info-card-content`,children:[(0,A.jsx)(`p`,{className:`info-title`,children:e?.title??`-`}),(0,A.jsx)(`p`,{className:`info-description`,children:e?.description??`-`})]})]},`${e?.title??`item`}-${t}`))})]})})}function xp({section:e}){let t=e?.content??{};return(0,A.jsx)(Op,{children:(0,A.jsxs)(`section`,{className:`career-block career-split`,children:[(0,A.jsxs)(`div`,{className:`about-copy`,children:[(0,A.jsx)(`h3`,{children:t?.title??`Detalle`}),(0,A.jsx)(`p`,{children:t?.description??``})]}),(0,A.jsx)(vp,{image:t?.image,title:t?.title})]})})}function Sp({section:e}){let t=e?.content??{};return(0,A.jsx)(Op,{children:(0,A.jsxs)(`section`,{className:`career-block`,children:[(0,A.jsx)(`h3`,{children:t?.title??`Perfil`}),(0,A.jsx)(`p`,{children:t?.description??``})]})})}function Cp({section:e}){let t=e?.content??{},n=Array.isArray(t?.description)?t.description:[];return(0,A.jsx)(Op,{children:(0,A.jsxs)(`section`,{className:`career-block`,children:[(0,A.jsx)(`h3`,{children:t?.title??`Contenidos`}),(0,A.jsx)(`div`,{className:`contents-grid`,children:n.map((e,t)=>(0,A.jsxs)(`div`,{className:`content-group`,children:[(0,A.jsxs)(`p`,{children:[`Año `,t+1]}),Array.isArray(e)&&e.length>0?(0,A.jsx)(`ul`,{children:e.map((e,n)=>(0,A.jsx)(`li`,{children:String(e)},`item-${t}-${n}`))}):(0,A.jsx)(`p`,{className:`muted`,children:`Sin contenidos cargados`})]},`group-${t}`))})]})})}function wp({section:e}){let t=Array.isArray(e?.questions)?e.questions:[],n=Array.isArray(e?.answers)?e.answers:[];return(0,A.jsx)(Op,{children:(0,A.jsxs)(`section`,{className:`career-block`,children:[(0,A.jsx)(`h3`,{children:`Preguntas frecuentes`}),(0,A.jsx)(`div`,{className:`faq-list`,children:t.map((e,t)=>(0,A.jsxs)(`article`,{className:`faq-item`,children:[(0,A.jsx)(`h4`,{children:e}),(0,A.jsx)(`p`,{children:n[t]??`Respuesta pendiente`})]},`faq-${t}`))})]})})}function Tp({section:e}){return(0,A.jsx)(Op,{children:(0,A.jsxs)(`section`,{className:`career-block`,children:[(0,A.jsx)(`h3`,{children:`Seccion no mapeada`}),(0,A.jsxs)(`p`,{children:[`Type: `,e?.type??`desconocido`]})]})})}var Ep={banner:yp,"info-cards":bp,about:xp,profile:Sp,contents:Cp,faq:wp};function Dp(e){return Ep[String(e??``).trim().toLowerCase()]??Tp}var Op=Ha.div`
  width: 100%;
...
`;function kp(){let{theme:e}=Wn(),{careerCode:t}=vt(),n=String(t??``).trim().toUpperCase(),r=gp?.careers??{},i=n?r?.[n]:null,a=Array.isArray(i?.sections)?i.sections:[],o=!!(n&&i&&a.length>0);return(0,A.jsxs)(Ap,{className:`app ${e}`,children:[(0,A.jsx)(jf,{}),(0,A.jsx)(`main`,{className:`oferta-main`,children:o?a.map((e,t)=>{let r=Dp(e?.type);return(0,A.jsx)(r,{section:e,career:i,careerCode:n},`${e?.type??`section`}-${t}`)}):(0,A.jsxs)(`section`,{className:`not-found`,role:`status`,"aria-live":`polite`,children:[(0,A.jsx)(`p`,{className:`not-found-kicker`,children:`404 Not Found`}),(0,A.jsx)(`h1`,{children:`Carrera no disponible`}),(0,A.jsxs)(`p`,{children:[`No encontramos contenido para el codigo "`,t||`sin-codigo`,`".`]})]})}),(0,A.jsx)(fp,{})]})}var Ap=Ha.div`
  width: min(80%, 1440px);
  margin: 0 auto;
...
`;function jp(){return(0,A.jsxs)(Ut,{children:[(0,A.jsx)(Vt,{path:`/`,element:(0,A.jsx)(mp,{})}),(0,A.jsx)(Vt,{path:`/oferta-educativa`,element:(0,A.jsx)(kp,{})}),(0,A.jsx)(Vt,{path:`/oferta-educativa/:careerCode`,element:(0,A.jsx)(kp,{})}),(0,A.jsx)(Vt,{path:`*`,element:(0,A.jsx)(Bt,{to:`/`,replace:!0})})]})}(0,Bn.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(x.StrictMode,{children:(0,A.jsx)(Un,{children:(0,A.jsx)(On,{children:(0,A.jsx)(jp,{})})})}));