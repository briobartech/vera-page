...
`;function Bf({name:e,icon:t,to:n=`/oferta-educativa`,reflectionColor:r=`rgba(186, 142, 166, 0.72)`}){return(0,A.jsx)(Vf,{className:`careers-buttons`,$reflectionColor:r,children:(0,A.jsxs)(kn,{to:n,className:`careers-button`,children:[(0,A.jsx)(`span`,{className:`careers-icon-shell`,"aria-hidden":`true`,children:(0,A.jsx)(`img`,{src:t,alt:e,className:`careers-icon`})}),(0,A.jsx)(`span`,{className:`careers-label-shell`,children:(0,A.jsx)(`span`,{children:e})})]})})}var Vf=Ha.div`
...
`;function Ap(){let{theme:e}=Wn(),{careerCode:t}=vt(),n=String(t??``).trim().toUpperCase(),r=_p?.careers??{},i=n?r?.[n]:null,a=Array.isArray(i?.sections)?i.sections:[],o=!!(n&&i&&a.length>0);return(0,A.jsxs)(jp,{className:`app ${e}`,children:[(0,A.jsx)(Mf,{}),(0,A.jsx)(`main`,{className:`oferta-main`,children:o?a.map((e,t)=>{let r=Op(e?.type);return(0,A.jsx)(r,{section:e,career:i,careerCode:n},`${e?.type??`section`}-${t}`)}):(0,A.jsxs)(`section`,{className:`not-found`,role:`status`,"aria-live":`polite`,children:[(0,A.jsx)(`p`,{className:`not-found-kicker`,children:`404 Not Found`}),(0,A.jsx)(`h1`,{children:`Carrera no disponible`}),(0,A.jsxs)(`p`,{children:[`No encontramos contenido para el codigo "`,t||`sin-codigo`,`".`]})]})}),(0,A.jsx)(pp,{})]})}var jp=Ha.div`
  width: min(80%, 1440px);
  margin: 0 auto;
...
`;function Mp(){return(0,A.jsxs)(Ut,{children:[(0,A.jsx)(Vt,{path:`/`,element:(0,A.jsx)(hp,{})}),(0,A.jsx)(Vt,{path:`/oferta-educativa`,element:(0,A.jsx)(Ap,{})}),(0,A.jsx)(Vt,{path:`/oferta-educativa/:careerCode`,element:(0,A.jsx)(Ap,{})}),(0,A.jsx)(Vt,{path:`*`,element:(0,A.jsx)(Bt,{to:`/`,replace:!0})})]})}(0,Bn.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(x.StrictMode,{children:(0,A.jsx)(Un,{children:(0,A.jsx)(On,{children:(0,A.jsx)(Mp,{})})})}));